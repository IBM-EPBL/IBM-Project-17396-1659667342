#A python code assume you get temperature and humidity values generated with random function to a variable and write a condition to continuosly detect alram in case of high temperature 
